...
var file_user_proto_depIdxs = []int32{
	...
	2, // 1: user.UserService.Delete:input_type -> user.DeleteRequest
	4, // 2: user.UserService.ResetPassword:input_type -> user.ResetPasswordRequest
	1, // 3: user.UserService.Create:output_type -> user.CreateResponse
	3, // 4: user.UserService.Delete:output_type -> user.DeleteResponse
	5, // 5: user.UserService.ResetPassword:output_type -> user.ResetPasswordResponse
