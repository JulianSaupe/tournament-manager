...
const (
	PermissionService_CreatePermission_FullMethodName    = "/authorization.PermissionService/CreatePermission"
	PermissionService_GetPermissionByName_FullMethodName = "/authorization.PermissionService/GetPermissionByName"
	PermissionService_ListPermissions_FullMethodName     = "/authorization.PermissionService/ListPermissions"
	PermissionService_UpdatePermission_FullMethodName    = "/authorization.PermissionService/UpdatePermission"
	PermissionService_DeletePermission_FullMethodName    = "/authorization.PermissionService/DeletePermission"
)
...
type PermissionServiceClient interface {
	...
	GetPermissionByName(ctx context.Context, in *GetPermissionByNameRequest, opts ...grpc.CallOption) (*GetPermissionResponse, error)
...
func (c *permissionServiceClient) GetPermissionByName(ctx context.Context, in *GetPermissionByNameRequest, opts ...grpc.CallOption) (*GetPermissionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type PermissionServiceServer interface {
	...
	GetPermissionByName(context.Context, *GetPermissionByNameRequest) (*GetPermissionResponse, error)
...
func (UnimplementedPermissionServiceServer) GetPermissionByName(context.Context, *GetPermissionByNameRequest) (*GetPermissionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetPermissionByName not implemented")
}
...
var PermissionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "authorization.PermissionService",
	...
	Metadata: "authorization/permission.proto",
}
