<script lang="ts">
    ...
    import {type Qualifying, QualifyingFilter} from '$lib/domain/qualifying';
...
<div class="mb-8 grid grid-cols-2 gap-3 sm:grid-cols-2 md:gap-4 lg:grid-cols-4">
    <div class="stat rounded-box bg-base-100 p-3 shadow md:p-6">
        ...
        <div class="stat-value text-lg sm:text-2xl md:text-3xl">
...
<div class="mb-8">
    <div class="mb-6 flex flex-col items-start justify-between gap-3 sm:flex-row sm:items-center">
        <h2 class="flex items-center text-xl font-semibold sm:text-2xl">Qualifying</h2>
        <div class="mb-2 flex gap-2">
            <div class="dropdown dropdown-end">
                ...
                <ul class="dropdown-content menu z-[1] w-52 rounded-box bg-base-100 p-2 shadow">
                    <li>
                        <button class="justify-between" onclick={() => (statusFilter = QualifyingFilter.ALL)}>
                            All
                    ...
                    <li>
                        <button
                                ...
                                onclick={() => (statusFilter = QualifyingFilter.QUALIFIED)}
                        >
                            Qualified
                    ...
                    <li>
                        <button
                                class="justify-between"
                                onclick={() => (statusFilter = QualifyingFilter.UNQUALIFIED)}
                        >
                            Unqualified
...
<h2 class="flex items-center text-xl font-semibold sm:text-2xl">Players</h2>
