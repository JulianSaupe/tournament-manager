		...
		<div class="grid grid-cols-2 gap-6">
			...
			<div class="form-control w-full">
				...
				<input
					...
					class="input-bordered input w-full {$tournamentForm.errors.name ? 'input-error' : ''}"
			...
			<div class="form-control w-full">
				...
				<input
					...
					min="1"
					class="input-bordered input w-full {$tournamentForm.errors.playerCount
						? 'input-error'
						: ''}"
			...
			<div class="form-control w-full">
				...
				<input
					...
					class="input-bordered input w-full {$tournamentForm.errors.startDate
						? 'input-error'
						: ''}"
				/>
			...
			<div class="form-control w-full">
				...
				<input
					...
					class="input-bordered input w-full {$tournamentForm.errors.endDate ? 'input-error' : ''}"
				/>
