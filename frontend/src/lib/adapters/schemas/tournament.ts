...
const TournamentSchema: z.ZodType<Tournament> = z.object({
    id: z.string(),
    name: z.string(),
...
export const TournamentApiSchema: z.ZodType<Tournament> = BaseApiSchema(TournamentSchema).transform((response) => {
